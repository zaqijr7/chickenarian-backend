...
CREATE TABLE `feeds` (
  ...
  `type_of_feed` enum('paddy','corn','wheat') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
CREATE TABLE `pets` (
  `id_pet` int NOT NULL,
  `id_user` int NOT NULL,
  `pet_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
